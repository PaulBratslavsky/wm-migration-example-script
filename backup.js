...
// Update ImageCacheManager to proper singleton pattern
const ImageCacheManager = (function() {
  let instance;
...
// Add error handling for downloadAndUploadFile
...
// Update the importWPData function to remove timestamp from slug
